...
export const Route = createFileRoute("/production-ready")({
  head: () => ({
    ...
    meta: [
      { title: "Production-Ready Platform — Zoryn Nexus" },
      {
        name: "description",
        content:
          "Live production-state platform view: lifecycle statuses, onboarding, banking, acquiring, rewards and operations across the Zoryn adapters.",
      },
      { property: "og:title", content: "Production-Ready Platform — Zoryn Nexus" },
      {
        property: "og:description",
        content:
          "Lifecycle statuses, onboarding, banking, acquiring, rewards and operations across the Zoryn adapters.",
      },
  ...
  errorComponent: ({ error }) => (
    <main role="alert" className="p-10 text-foreground">
      Platform data unavailable: {error.message}
    </main>
  ),

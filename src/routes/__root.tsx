...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zoryn — Money, payments and rewards" },
      {
        name: "description",
        content:
          "Zoryn by LoungeTech: personal banking, business accounts, ZorynPay acquiring and admin operations in one connected financial experience.",
      },
      { name: "author", content: "LoungeTech" },

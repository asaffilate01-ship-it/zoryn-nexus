  ...
  head: () => ({
    ...
    meta: [
      { title: "Operations — Zoryn provider health and webhook states" },
      {
        name: "description",
        content:
          "KYC/KYB queues, risk alerts, complaint SLAs, provider health and webhook retry, failure and duplicate-event states.",
      },
      { property: "og:title", content: "Operations — Zoryn provider health and webhook states" },
      {
        property: "og:description",
        content:
          "KYC/KYB queues, risk alerts, complaint SLAs, provider health and webhook processing states.",
      },

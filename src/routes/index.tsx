...
function CorporateHome() {
  ...
  const ecosystemCards: [typeof Globe2, string, string][] = [
    [
      Landmark,
      t("Shared identity"),
      t("A single verified Zoryn identity works across personal, business and merchant products."),
    ],
    [
      Gift,
      t("Shared rewards"),
      t("Points earned anywhere in the ecosystem spend anywhere — cash, pots or partner offers."),
    ],
    [
      Globe2,
      t("Shared operations"),
      t("Compliance queues, provider monitoring and audit logging run centrally at LoungeTech."),
    ],
  ];
          ...
          <div className="mt-4 grid gap-10 lg:grid-cols-[1.1fr_1fr]">
            <div>
              <h2 className="font-display text-3xl sm:text-4xl">
                {t("Money, payments and rewards, connected")}
              </h2>
            ...
            <div
              id="offer"
              className="scroll-mt-24 rounded-2xl border border-border bg-background/50 p-6"
            >
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-12 sm:px-8 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t("Money. Payments. Rewards. By LoungeTech.")}
            </p>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#europe" className="hover:text-foreground">
                  {t("Germany & Europe")}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/products" hash="personal" className="hover:text-foreground">
                  Zoryn Personal
                </Link>
              </li>
              <li>
                <Link to="/products" hash="business" className="hover:text-foreground">
                  Zoryn Business
                </Link>
              </li>
              <li>
                <Link to="/products" hash="pay" className="hover:text-foreground">
                  ZorynPay
                </Link>
              </li>
              <li>
                <Link to="/products" hash="rewards" className="hover:text-foreground">
                  Zoryn Rewards
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/personal" className="hover:text-foreground">
                  {t("Personal portal")}
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-border/60 px-5 py-6 text-center text-xs text-muted-foreground sm:px-8">
          {t("© {year} Zoryn — a LoungeTech platform. Demo environment.", {
